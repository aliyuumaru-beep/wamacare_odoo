...
**Rule:** This is the single source of truth for all WamaCare features. All features are derived from actual project documents and implementation evidence. No features are invented.
...
| Status | Meaning |
|--------|---------|
| COMPLETED | Implemented, validated, in production database |
| PARTIAL | Module installed or partially configured; not fully operational |
...
| GOV-005 | Two-Factor Authentication | TOTP available for all users | MEDIUM | COMPLETED | 1.0 |
| GOV-006 | Fiscal Year Management | Annual fiscal year close and lock | MEDIUM | COMPLETED | 1.0 |
...
| HR-005 | Skills Tracking | Employee skills catalogue | MEDIUM | PARTIAL | 1.0 |
| HR-006 | Staff Onboarding Checklist | Structured onboarding workflow | MEDIUM | PARTIAL | 1.0 |
...
| PROG-003 | Budget per Programme | Budget module installed and linked | HIGH | COMPLETED | 1.0 |
| PROG-004 | Activity Calendar | Calendar module installed | MEDIUM | COMPLETED | 1.0 |
| PROG-005 | Task and Activity Tracking | Project tasks available per programme | HIGH | PARTIAL | 1.0 |
| PROG-006 | Programme Dashboard | Spreadsheet dashboard for programme view | HIGH | PARTIAL | 1.0 |
| PROG-007 | Milestone Tracking | Programme milestone configuration | MEDIUM | PARTIAL | 1.0 |
...
| ID | Feature | Description | Priority | Status | Release |
|----|---------|-------------|---------|--------|---------|
| DONOR-001 | Donor Contact Records | Donor/funder partners in contacts | HIGH | PARTIAL | 1.0 |
| DONOR-002 | Grant Analytic Accounts | Per-grant fund tracking via analytic accounts | HIGH | COMPLETED | 1.0 |
| DONOR-003 | Recurring Payment Management | Recurring donor payment schedules | MEDIUM | COMPLETED | 1.0 |
| DONOR-004 | Donor Follow-Up | Automated donor payment reminders | MEDIUM | COMPLETED | 1.0 |
...
| PROC-002 | Local Purchase Order (LPO) | LPO creation and tracking | HIGH | COMPLETED | 1.0 |
...
| PROC-006 | Procurement Reports | Standard purchase PDF reports | MEDIUM | COMPLETED | 1.0 |
...
| FIN-007 | Asset Depreciation | Fixed asset depreciation schedules | HIGH | COMPLETED | 1.0 |
| FIN-008 | Recurring Payments | Automated recurring transactions | MEDIUM | COMPLETED | 1.0 |
| FIN-009 | Daily Financial Reports | om_account_daily_reports | MEDIUM | COMPLETED | 1.0 |
| FIN-010 | Full Accounting Suite | om_account_accountant dashboard | HIGH | COMPLETED | 1.0 |
| FIN-011 | FIRS Tax Report | Structured FIRS reporting format | HIGH | COMPLETED | 1.0 |
...
| ID | Feature | Description | Priority | Status | Release |
|----|---------|-------------|---------|--------|---------|
| ASSET-001 | Asset Register | 3 assets: Ambulance, Ultrasound, Laptop | HIGH | COMPLETED | 1.0 |
| ASSET-002 | Asset Depreciation Module | om_account_asset installed | HIGH | COMPLETED | 1.0 |
| ASSET-003 | Equipment Categories | Categorise assets by type | LOW | PARTIAL | 1.0 |
| ASSET-004 | Asset Assignment | Assign assets to departments/programmes | MEDIUM | PARTIAL | 1.0 |
| ASSET-005 | Maintenance Scheduling | Preventive maintenance calendar | MEDIUM | PARTIAL | 1.0 |
...
| ID | Feature | Description | Priority | Status | Release |
|----|---------|-------------|---------|--------|---------|
| BEN-001 | Beneficiary Registration | 13 beneficiaries (BEN-004 to BEN-016) | HIGH | COMPLETED | 1.0 |
| BEN-002 | Programme Tagging | Beneficiaries tagged by programme | HIGH | COMPLETED | 1.0 |
| BEN-003 | Geolocation Mapping | FCT area coordinates on beneficiary records | MEDIUM | COMPLETED | 1.0 |
| BEN-004 | Gender Tagging | Female/Male category tags | HIGH | COMPLETED | 1.0 |
...
| ME-003 | Budget vs Actual | Programme financial performance | HIGH | COMPLETED | 1.0 |
| ME-004 | Programme Dashboard | Spreadsheet dashboard engine installed | HIGH | PARTIAL | 1.0 |
...
| ID | Feature | Description | Priority | Status | Release |
|----|---------|-------------|---------|--------|---------|
| EXEC-001 | Financial Dashboard | Account spreadsheet dashboard | HIGH | COMPLETED | 1.0 |
| EXEC-002 | Procurement Dashboard | Purchase spreadsheet dashboard | HIGH | COMPLETED | 1.0 |
...
| Domain | COMPLETED | PARTIAL | PLANNED | DEFERRED | TOTAL |
|--------|-----------|---------|---------|---------|-------|
| Governance (GOV) | 6 | 0 | 4 | 0 | 10 |
| HR | 4 | 2 | 6 | 1 | 13 |
| Programme (PROG) | 4 | 3 | 3 | 0 | 10 |
| Donor (DONOR) | 3 | 1 | 4 | 0 | 8 |
| Procurement (PROC) | 6 | 0 | 3 | 0 | 9 |
| Finance (FIN) | 11 | 3 | 1 | 0 | 15 |
| Asset (ASSET) | 2 | 2 | 3 | 0 | 7 |
| Inventory (INV) | 1 | 0 | 6 | 0 | 7 |
| Beneficiary (BEN) | 4 | 1 | 4 | 0 | 9 |
| Safeguarding (SAFE) | 3 | 1 | 5 | 1 | 10 |
| Entrepreneurship (ENT) | 0 | 0 | 7 | 0 | 7 |
| M&E (ME) | 3 | 1 | 4 | 0 | 8 |
| Exec Dashboard (EXEC) | 3 | 0 | 3 | 0 | 6 |
| Healthcare (HEALTH) | 3 | 1 | 2 | 0 | 6 |
| **TOTAL** | **53** | **15** | **55** | **2** | **125** |

**53 features COMPLETED | 15 PARTIAL | 55 PLANNED | 2 DEFERRED | 125 total**
